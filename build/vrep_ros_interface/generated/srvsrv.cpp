    ...
    else if(in->serviceType == "plutodrone/PlutoPilot")
    {
        serviceServerProxy->server = nh->advertiseService<plutodrone::PlutoPilot::Request, plutodrone::PlutoPilot::Response>(in->serviceName, boost::bind(ros_srv_callback__plutodrone__PlutoPilot, _1, _2, serviceServerProxy));
    }
